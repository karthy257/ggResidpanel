...
plot_constlev <- function(model, type, theme, axis.text.size, title.text.size, title.opt, color){
  ...
  plot <- ggplot(data = model_values, aes_string(x = "Variables", y = "Std_Res", color = color), na.rm=TRUE) +
